...
<style>
	#intro_main .bold{font-weight: bold; color:green;}
	#intro_main #str_intro ul li{list-style-type: square;}
</style>
<div id="intro_main">
	<h2>휴양림 안내</h2>

	<h4>시내중심부를 낙동강이 흐르면서 구미의 또다른 자랑이 될 옥성자연휴양림을 방문하여 주셔서 진심으로 환영합니다.</h4>
	
	<p>옥성자연휴양림은 첨단산업뿐만 아니라 역사와 전통을 가진 맑고 깨끗한 자연경관을 지닌 구미의 새로운<br> 
	관광자원으로 사람에게 좋다는 황토를 이용한 숲속의 집은 물론 큰 저수지와 함께 어우러져 있는 <br>
	수변데크, 야영데크, 산림욕을 즐길 수 있는 산책로와 등산로는 물론 원두막, 자연관찰원, 숲속교실 등<br>
	다양하고 편안한 시설로 이용객을 맞이하고 있습니다.</p>
	
	<p>일상의 스트레스를 벗어나 자연을 벗삼아 휴식을 취하시려는 여러분. 옥성자연휴양림을 찾아주세요.</p>
	
	<p>옥성자연휴양림은 여러분 모두를 환영합니다.</p>
