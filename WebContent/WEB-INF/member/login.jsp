...
.login_join_field #sub{background:#FFBB83 !important; width:370px !important; border-radius: 15px; height:46px; color:#fff; font-family:"NanumSquareB"; font-size:20px;}
.bottom_btn p{font-size:14px; width:500px; margin:0 auto; margin-top:30px;} 
.bottom_btn a{color:#cc0000;}
</style>
</head>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
